    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inventories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="vehicle">Vehicle ID</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine_type') ? 'is-invalid' : '' }}" type="text" name="engine_type" id="engine_type" value="{{ old('engine_type', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transmission') ? 'is-invalid' : '' }}" type="text" name="transmission" id="transmission" value="{{ old('transmission', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interior_color') ? 'is-invalid' : '' }}" type="text" name="interior_color" id="interior_color" value="{{ old('interior_color', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exterior_color') ? 'is-invalid' : '' }}" type="text" name="exterior_color" id="exterior_color" value="{{ old('exterior_color', '') }}">
